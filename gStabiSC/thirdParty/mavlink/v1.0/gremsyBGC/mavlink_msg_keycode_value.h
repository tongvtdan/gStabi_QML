...
typedef struct __mavlink_keycode_value_t
{
 ...
 uint8_t device_name4; ///< name of device: can be one of following values: GSTABI, GMOTION
 ...
 *
 * @param device_name4 name of device: can be one of following values: GSTABI, GMOTION
